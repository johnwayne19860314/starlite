...
declare namespace API {
  ...
  type UsersListResponse = ResponstBody<UsersList>;

  type DelUserResult = {
    success : boolean
  };
  type DelUserResponse = ResponstBody<DelUserResult>;
  ...
  type ListEntriesData = {
    entries: DataSourceItem[];
  };

  /** 登录响应结果 */
  type ListEntriesResponse = ResponstBody<ListEntriesData>;
  ...
  type ListEntryCategoryData = {
    items: EntryCategory[]
  }
  type ListEntryCategoryResponse = ResponstBody<ListEntryCategoryData>;
  type EntryCategoryResponse = ResponstBody<EntryCategory>;
  ...
  type EntryResponse = ResponstBody<EntryRequest>

  // type DelEntryRequest = {
  //   code : string
  // }
  type DelEntryResult = {
    success : boolean
  }
  type DelEntryResponse = ResponstBody<DelEntryResult>
